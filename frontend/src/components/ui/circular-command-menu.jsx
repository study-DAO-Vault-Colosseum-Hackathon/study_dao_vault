              ...
              return (
                <motion.button
                  ...
                  className={cn(
                    ...
                    isActive && "ring-2 ring-blue-600 bg-gray-100",
                  )}
                  role="menuitem"
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute left-full ml-3 whitespace-nowrap rounded-md bg-gray-900 px-2 py-1 text-xs text-white shadow-md border border-gray-700"
                  >
